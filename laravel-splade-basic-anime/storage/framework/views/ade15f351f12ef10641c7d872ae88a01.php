                ...
                <div class="order__wrapper">
                    ...
                    <div class="order__order-content">
                        ...
                        <div class="order__content-form">
                            <form class="order__form" action="<?php echo e(route('client.order')); ?>" enctype="multipart/form-data" method="POST">
...
<?php echo $__env->make('client.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\mariz\matiz\laravel-splade-basic-anime\resources\views/client/index.blade.php ENDPATH**/ ?>