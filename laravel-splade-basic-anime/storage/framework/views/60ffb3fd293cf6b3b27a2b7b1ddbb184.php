<?php \ProtoneMedia\Splade\Facades\SEO::title(__('Новая категория')); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="w-full flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Новая карточка')); ?>

            </h2>
            <a href="<?php echo e(route('cards.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center"><?php echo e(__('К списку карточек')); ?></a>
        </div>
    <?php $__env->endSlot(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(route('cards.store')).'']); ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\mariz\matiz\laravel-splade-basic-anime\resources\views/admin/cards/create.blade.php ENDPATH**/ ?>